...
// 16833
int ORBmatcher::SearchByBoW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches, std::vector<int> &trainIdx, std::vector<int> &queryIdx)
{
    const vector<MapPoint*> vpMapPointsKF = pKF->GetMapPointMatches();
